...
INDICATORS = [
    ...
    ("tea",               "faostat",   "Tea Production",                 " t",    "food",    1961, 2, ["world","asia"]),
    ("wine",              "faostat",   "Wine Production",                " t",    "food",    1961, 2, ["world","europe"]),
    ("sugar",             "faostat",   "Sugar Production",               " t",    "food",    1961, 2, ["world","americas"]),
    ...
    ("olive",             "faostat",   "Olive Production",               " t",    "food",    1961, 3, ["world"]),
    ("honey",             "faostat",   "Honey Production",               " t",    "food",    1961, 3, ["world"]),
    ...
    ("cattle",            "faostat",   "Cattle Population",              "",      "food",    1961, 3, ["world"]),
    ("sheep",             "faostat",   "Sheep Population",               "",      "food",    1961, 3, ["world"]),
    ("chicken",           "faostat",   "Chicken Population",             "",      "food",    1961, 3, ["world"]),
]
